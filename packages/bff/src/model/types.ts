...
import { api as tenantApi } from "./generated/tenant-process/api.js";
import { z } from "zod";

type PurposeApi = typeof purposeApi.api;
type TenantApi = typeof tenantApi.api;
...
export type Tenant = ZodiosResponseByPath<TenantApi, "get", "/tenants/:id">;
