...
const Attribute = z
  .object({ id: z.string().uuid(), explicitAttributeVerification: z.boolean() })
  .passthrough();
const Attributes = z
  .object({
...
const EService = z
  ...
  .passthrough();
const EServices = z
  .object({ results: z.array(EService), totalCount: z.number().int() })
  .passthrough();
const EServiceSeed = z
  .object({
...
const EServiceConsumer = z
  ...
  .passthrough();
const EServiceConsumers = z
  .object({ results: z.array(EServiceConsumer), totalCount: z.number().int() })
  .passthrough();
const AttributeSeed = z
  .object({ id: z.string().uuid(), explicitAttributeVerification: z.boolean() })
  .passthrough();
const AttributesSeed = z
  .object({
    certified: z.array(z.array(AttributeSeed)),
    declared: z.array(z.array(AttributeSeed)),
    verified: z.array(z.array(AttributeSeed)),
  })
  .passthrough();
const EServiceDescriptorSeed = z
  .object({
  ...
  .passthrough();
const UpdateEServiceDescriptorSeed = z
  .object({
    description: z.string().min(10).max(250).optional(),
    audience: z.array(z.string()),
    voucherLifespan: z.number().int().gte(60).lte(86400),
...
const CreateEServiceDescriptorDocumentSeed = z
  .object({
  ...
  .passthrough();
const UpdateEServiceDescriptorDocumentSeed = z
  .object({ prettyName: z.string().min(5).max(60) })
  .passthrough();
...
const endpoints = makeApi([
  {
    ...
    parameters: [
      ...
      },
      {
        name: "eservicesIds",
        type: "Query",
        schema: z.array(z.string().brand("Test")).default([]).optional(),
      },
      {
        name: "producersIds",
        type: "Query",
      ...
      },
      {
        name: "states",
        type: "Query",
        schema: z.array(EServiceDescriptorState).default([]).optional(),
      },
      {
        name: "agreementStates",
        type: "Query",
        schema: z.array(AgreementState).default([]).optional(),
      },
      {
        name: "offset",
        type: "Query",
  ...
  },
  {
    ...
    alias: "cloneEServiceByDescriptor",
    requestFormat: "json",
    parameters: [
      {
        name: "X-Correlation-Id",
  ...
  },
  {
    method: "delete",
    path: "/eservices/:eServiceId/descriptors/:descriptorId/documents/:documentId",
    alias: "deleteEServiceDocumentById",
    requestFormat: "json",
    parameters: [
      {
        name: "X-Correlation-Id",
  ...
  },
  {
    ...
    alias: "updateEServiceDocumentById",
    requestFormat: "json",
    parameters: [
      {
        name: "body",
