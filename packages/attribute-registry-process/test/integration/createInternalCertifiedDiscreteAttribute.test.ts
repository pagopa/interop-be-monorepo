...
describe("certified discrete attribute internal creation", () => {
  const mockTenant = getMockTenant();
  const mockAttribute = getMockAttribute();

  it("should write on event-store for the internal creation of a certified discrete attribute", async () => {
    const tenant: Tenant = {
      ...mockTenant,
      features: [
        {
