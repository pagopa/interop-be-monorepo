...
describe("API /certifiedDiscreteAttributes authorization test", () => {
  const mockCertifiedDiscreteAttributeSeed: attributeRegistryApi.CertifiedDiscreteAttributeSeed =
    {
  ...
  attributeRegistryService.createCertifiedDiscreteAttribute = vi
    .fn()
  ...
  const makeRequest = async (token: string) =>
    request(api)
      ...
      .send(mockCertifiedDiscreteAttributeSeed);
    ...
    attributeRegistryService.createCertifiedDiscreteAttribute = vi
      ...
      .mockRejectedValue(
        attributeDuplicateByCodeOriginOrName(
          mockCertifiedDiscreteAttributeSeed.name,
          mockCertifiedDiscreteAttributeSeed.code,
          "origin"
        )
      );
  ...
  it("Should return 400 if passed an invalid certified discrete attribute seed", async () => {
