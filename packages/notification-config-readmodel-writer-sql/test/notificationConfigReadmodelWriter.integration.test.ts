    ...
    it("TenantNotificationConfigUpdated", async () => {
      ...
      const updatedTenantNotificationConfig: TenantNotificationConfig = {
        ...
        config: {
          ...
          eserviceStatusChangedToConsumer: true,
          ...
          newEserviceTemplateVersionToInstatiator: true,
          eserviceTemplateNameChangedToInstatiator: true,
          ...
          clientKeyStatusChangedToClientUsers: true,
        },
      };
