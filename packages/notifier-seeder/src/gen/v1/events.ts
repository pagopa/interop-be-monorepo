...
class CatalogItemV1$Type extends MessageType<CatalogItemV1> {
    constructor() {
        super("catalog.CatalogItemV1", [
            ...
            { no: 5, name: "technology", kind: "enum", T: () => ["catalog.CatalogItemTechnologyV1", CatalogItemTechnologyV1] },
            ...
            { no: 9, name: "riskAnalysis", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => CatalogItemRiskAnalysisV1 },
            { no: 10, name: "mode", kind: "enum", opt: true, T: () => ["catalog.CatalogItemModeV1", CatalogItemModeV1] }
        ]);
    }
    create(value?: PartialMessage<CatalogItemV1>): CatalogItemV1 {
        const message = { id: "", producerId: "", name: "", description: "", technology: 0, descriptors: [], riskAnalysis: [] };
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* repeated catalog.CatalogItemRiskAnalysisV1 riskAnalysis */ 9:
                    message.riskAnalysis.push(CatalogItemRiskAnalysisV1.internalBinaryRead(reader, reader.uint32(), options));
                    break;
    ...
    internalBinaryWrite(message: CatalogItemV1, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        for (let i = 0; i < message.riskAnalysis.length; i++)
            CatalogItemRiskAnalysisV1.internalBinaryWrite(message.riskAnalysis[i], writer.tag(9, WireType.LengthDelimited).fork(), options).join();
...
class CatalogItemRiskAnalysisV1$Type extends MessageType<CatalogItemRiskAnalysisV1> {
    constructor() {
        super("catalog.CatalogItemRiskAnalysisV1", [
            ...
            { no: 3, name: "riskAnalysisForm", kind: "message", T: () => CatalogRiskAnalysisFormV1 },
            { no: 4, name: "createdAt", kind: "scalar", T: 3 /*ScalarType.INT64*/, L: 0 /*LongType.BIGINT*/ }
        ]);
    }
    create(value?: PartialMessage<CatalogItemRiskAnalysisV1>): CatalogItemRiskAnalysisV1 {
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: CatalogItemRiskAnalysisV1): CatalogItemRiskAnalysisV1 {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                ...
                case /* catalog.CatalogRiskAnalysisFormV1 riskAnalysisForm */ 3:
                    message.riskAnalysisForm = CatalogRiskAnalysisFormV1.internalBinaryRead(reader, reader.uint32(), options, message.riskAnalysisForm);
                    break;
    ...
    internalBinaryWrite(message: CatalogItemRiskAnalysisV1, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* string id = 1; */
        if (message.id !== "")
            writer.tag(1, WireType.LengthDelimited).string(message.id);
        /* string name = 2; */
        ...
        if (message.riskAnalysisForm)
            CatalogRiskAnalysisFormV1.internalBinaryWrite(message.riskAnalysisForm, writer.tag(3, WireType.LengthDelimited).fork(), options).join();
        /* int64 createdAt = 4; */
...
class CatalogRiskAnalysisFormV1$Type extends MessageType<CatalogRiskAnalysisFormV1> {
    constructor() {
        super("catalog.CatalogRiskAnalysisFormV1", [
            ...
            { no: 3, name: "singleAnswers", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => CatalogRiskAnalysisSingleAnswerV1 },
            { no: 4, name: "multiAnswers", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => CatalogRiskAnalysisMultiAnswerV1 }
        ]);
    }
    create(value?: PartialMessage<CatalogRiskAnalysisFormV1>): CatalogRiskAnalysisFormV1 {
        const message = { id: "", version: "", singleAnswers: [], multiAnswers: [] };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
            reflectionMergePartial<CatalogRiskAnalysisFormV1>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: CatalogRiskAnalysisFormV1): CatalogRiskAnalysisFormV1 {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                ...
                case /* repeated catalog.CatalogRiskAnalysisSingleAnswerV1 singleAnswers */ 3:
                    message.singleAnswers.push(CatalogRiskAnalysisSingleAnswerV1.internalBinaryRead(reader, reader.uint32(), options));
                    break;
                case /* repeated catalog.CatalogRiskAnalysisMultiAnswerV1 multiAnswers */ 4:
                    message.multiAnswers.push(CatalogRiskAnalysisMultiAnswerV1.internalBinaryRead(reader, reader.uint32(), options));
                    break;
                default:
                    let u = options.readUnknownField;
                    if (u === "throw")
    ...
    internalBinaryWrite(message: CatalogRiskAnalysisFormV1, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* string id = 1; */
        if (message.id !== "")
            writer.tag(1, WireType.LengthDelimited).string(message.id);
        /* string version = 2; */
        ...
        for (let i = 0; i < message.singleAnswers.length; i++)
            CatalogRiskAnalysisSingleAnswerV1.internalBinaryWrite(message.singleAnswers[i], writer.tag(3, WireType.LengthDelimited).fork(), options).join();
        /* repeated catalog.CatalogRiskAnalysisMultiAnswerV1 multiAnswers = 4; */
        for (let i = 0; i < message.multiAnswers.length; i++)
            CatalogRiskAnalysisMultiAnswerV1.internalBinaryWrite(message.multiAnswers[i], writer.tag(4, WireType.LengthDelimited).fork(), options).join();
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
class CatalogRiskAnalysisSingleAnswerV1$Type extends MessageType<CatalogRiskAnalysisSingleAnswerV1> {
    ...
    create(value?: PartialMessage<CatalogRiskAnalysisSingleAnswerV1>): CatalogRiskAnalysisSingleAnswerV1 {
        const message = { id: "", key: "" };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
            reflectionMergePartial<CatalogRiskAnalysisSingleAnswerV1>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: CatalogRiskAnalysisSingleAnswerV1): CatalogRiskAnalysisSingleAnswerV1 {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: CatalogRiskAnalysisSingleAnswerV1, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* string id = 1; */
        if (message.id !== "")
            writer.tag(1, WireType.LengthDelimited).string(message.id);
        /* string key = 2; */
 ...
 */
export const CatalogRiskAnalysisSingleAnswerV1 = new CatalogRiskAnalysisSingleAnswerV1$Type();
// @generated message type with reflection information, may provide speed optimized methods
class CatalogRiskAnalysisMultiAnswerV1$Type extends MessageType<CatalogRiskAnalysisMultiAnswerV1> {
    ...
    create(value?: PartialMessage<CatalogRiskAnalysisMultiAnswerV1>): CatalogRiskAnalysisMultiAnswerV1 {
        const message = { id: "", key: "", values: [] };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
            reflectionMergePartial<CatalogRiskAnalysisMultiAnswerV1>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: CatalogRiskAnalysisMultiAnswerV1): CatalogRiskAnalysisMultiAnswerV1 {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: CatalogRiskAnalysisMultiAnswerV1, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* string id = 1; */
        if (message.id !== "")
            writer.tag(1, WireType.LengthDelimited).string(message.id);
        /* string key = 2; */
 ...
 */
export const CatalogRiskAnalysisMultiAnswerV1 = new CatalogRiskAnalysisMultiAnswerV1$Type();
// @generated message type with reflection information, may provide speed optimized methods
...
class CatalogDescriptorV1$Type extends MessageType<CatalogDescriptorV1> {
    constructor() {
        super("catalog.CatalogDescriptorV1", [
            ...
            { no: 5, name: "state", kind: "enum", T: () => ["catalog.CatalogDescriptorStateV1", CatalogDescriptorStateV1] },
            ...
            { no: 11, name: "agreementApprovalPolicy", kind: "enum", opt: true, T: () => ["catalog.AgreementApprovalPolicyV1", AgreementApprovalPolicyV1] },
...
class CatalogItemRiskAnalysisAddedV1$Type extends MessageType<CatalogItemRiskAnalysisAddedV1> {
    constructor() {
        super("catalog.CatalogItemRiskAnalysisAddedV1", [
            { no: 1, name: "catalogItem", kind: "message", T: () => CatalogItemV1 },
            { no: 2, name: "catalogRiskAnalysisId", kind: "scalar", T: 9 /*ScalarType.STRING*/ }
        ]);
    }
    create(value?: PartialMessage<CatalogItemRiskAnalysisAddedV1>): CatalogItemRiskAnalysisAddedV1 {
        const message = { catalogRiskAnalysisId: "" };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
            reflectionMergePartial<CatalogItemRiskAnalysisAddedV1>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: CatalogItemRiskAnalysisAddedV1): CatalogItemRiskAnalysisAddedV1 {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: CatalogItemRiskAnalysisAddedV1, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* catalog.CatalogItemV1 catalogItem = 1; */
        if (message.catalogItem)
            CatalogItemV1.internalBinaryWrite(message.catalogItem, writer.tag(1, WireType.LengthDelimited).fork(), options).join();
        /* string catalogRiskAnalysisId = 2; */
        if (message.catalogRiskAnalysisId !== "")
            writer.tag(2, WireType.LengthDelimited).string(message.catalogRiskAnalysisId);
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
 ...
 */
export const CatalogItemRiskAnalysisAddedV1 = new CatalogItemRiskAnalysisAddedV1$Type();
// @generated message type with reflection information, may provide speed optimized methods
class CatalogItemRiskAnalysisUpdatedV1$Type extends MessageType<CatalogItemRiskAnalysisUpdatedV1> {
    ...
    create(value?: PartialMessage<CatalogItemRiskAnalysisUpdatedV1>): CatalogItemRiskAnalysisUpdatedV1 {
        const message = { catalogRiskAnalysisId: "" };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
            reflectionMergePartial<CatalogItemRiskAnalysisUpdatedV1>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: CatalogItemRiskAnalysisUpdatedV1): CatalogItemRiskAnalysisUpdatedV1 {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: CatalogItemRiskAnalysisUpdatedV1, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* catalog.CatalogItemV1 catalogItem = 1; */
        if (message.catalogItem)
            CatalogItemV1.internalBinaryWrite(message.catalogItem, writer.tag(1, WireType.LengthDelimited).fork(), options).join();
        /* string catalogRiskAnalysisId = 2; */
 ...
 */
export const CatalogItemRiskAnalysisUpdatedV1 = new CatalogItemRiskAnalysisUpdatedV1$Type();
// @generated message type with reflection information, may provide speed optimized methods
class CatalogItemRiskAnalysisDeletedV1$Type extends MessageType<CatalogItemRiskAnalysisDeletedV1> {
    ...
    create(value?: PartialMessage<CatalogItemRiskAnalysisDeletedV1>): CatalogItemRiskAnalysisDeletedV1 {
        const message = { catalogRiskAnalysisId: "" };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
            reflectionMergePartial<CatalogItemRiskAnalysisDeletedV1>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: CatalogItemRiskAnalysisDeletedV1): CatalogItemRiskAnalysisDeletedV1 {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: CatalogItemRiskAnalysisDeletedV1, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* catalog.CatalogItemV1 catalogItem = 1; */
        if (message.catalogItem)
            CatalogItemV1.internalBinaryWrite(message.catalogItem, writer.tag(1, WireType.LengthDelimited).fork(), options).join();
        /* string catalogRiskAnalysisId = 2; */
 ...
 */
export const CatalogItemRiskAnalysisDeletedV1 = new CatalogItemRiskAnalysisDeletedV1$Type();
