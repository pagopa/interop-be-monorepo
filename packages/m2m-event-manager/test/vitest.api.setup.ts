...
import { M2MEventService } from "../src/services/m2mEventService.js";

export const m2mEventService = {} as M2MEventService;

export const api = await createApp(m2mEventService);
