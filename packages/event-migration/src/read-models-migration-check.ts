...
const Config = z
  .object({
    ...
    SCALA_READMODEL_DB_READ_PREFERENCE: z.string(),
    SCALA_READMODEL_DB_REPLICA_SET: z.string(),
    ...
    NODE_READMODEL_DB_READ_PREFERENCE: z.string(),
    NODE_READMODEL_DB_REPLICA_SET: z.string(),
  })
  .transform((c) => ({
