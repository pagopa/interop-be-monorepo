...
export const inAppTemplates = {
  newEServiceVersionPublishedToConsumer: (eserviceName: string): string =>
    `Ti informiamo che per l'e-service <strong>${eserviceName}</strong>, è stata pubblicata una nuova versione. Pertanto, ti consigliamo di procedere all'aggiornamento dell'e-service alla versione più recente.`,
