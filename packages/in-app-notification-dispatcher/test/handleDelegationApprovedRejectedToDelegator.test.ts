...
describe("handleDelegationApprovedRejectedToDelegator", () => {
  ...
  it.each<{
  ...
  }>([
    {
      ...
      expectedBody: `Ti informiamo che l'ente ${delegate.name} ha approvato la delega all'erogazione che il tuo ente gli ha conferito per l'e-service Test EService. La delega è ora attiva.`,
    },
    {
      eventType: "ConsumerDelegationApproved",
      kind: delegationKind.delegatedConsumer,
      expectedBody: `Ti informiamo che l'ente ${delegate.name} ha approvato la delega alla fruizione che il tuo ente gli ha conferito per l'e-service Test EService. La delega è ora attiva.`,
    },
    {
