  ...
  questions: [
    ...
    },
    {
      ...
      infoLabel: {
        ...
        en: "È previsto sia inserito l'atto amministrativo generale ai sensi dell’art. 2-ter, comma 1, del Codice Privacy per quanto attiene ai dati personali comuni e ai sensi dell’art. 2-sexies, comma 1 del Codice Privacy per quanto attiene alle categorie particolari di dati",
      },
      validation: {
        maxLength: 2000,
      },
      ...
      options: [
        ...
        },
        {
          label: {
            ...
            en: "In forma pseudoanonimizzata",
          },
    ...
    },
    {
      ...
      infoLabel: {
        ...
        en: "È previsto sia fornita un’informativa all’interessato circa l’accesso ai dati cui si intende accedere/che si intende ricevere tramite la fruizione dell’E-Service e le relative attività di trattamento effettuate dal Fruitore",
      },
      validation: {
        maxLength: 2000,
      },
    ...
    },
    {
      ...
      dataType: "single",
      label: {
        it: "Il presente E-service consente il download di dati?",
        en: "Il presente E-service consente il download di dati?",
      },
      infoLabel: {
    ...
    },
    {
      ...
      infoLabel: {
        it: "NB: se non già fatto, prima di confermare si invita a verificare se sul Catalogo API è presente un altro E-service che consenta di svolgere la mera attività di verifica di informazioni/dati personali di cui si necessita",
        en: "NB: se non già fatto, prima di confermare si invita a verificare se sul Catalogo API è presente un altro E-service che consenta di svolgere la mera attività di verifica di informazioni/dati personali di cui si necessita",
      },
      options: [
        {
          label: {
    ...
    },
    {
      ...
      dataType: "single",
      label: {
        it: "Confermare se è stato verificato se occorrono necessariamente tutte le informazioni e i dati personali messi a disposizione con il presente E-service",
        en: "Confermare se è stato verificato se occorrono necessariamente tutte le informazioni e i dati personali messi a disposizione con il presente E-service",
      },
      infoLabel: {
        it: "NB: se non già fatto, prima di confermare si invita a verificare se sul Catalogo API è già presente un altro E-service che consenta di accedere alle sole informazioni/dati personali di cui si necessita, per evitare comunicazioni di informazioni/dati personali non necessarie. Nel caso in cui non sia presente l’E-service per accedere alle sole informazioni/dati personali di cui si necessita, si invita a sollecitare un Erogatore ad attivare un simile E-service e, una volta attivato, si invita a inviare una richiesta di accesso per quell’E-Service",
        en: "NB: se non già fatto, prima di confermare si invita a verificare se sul Catalogo API è già presente un altro E-service che consenta di accedere alle sole informazioni/dati personali di cui si necessita, per evitare comunicazioni di informazioni/dati personali non necessarie. Nel caso in cui non sia presente l’E-service per accedere alle sole informazioni/dati personali di cui si necessita, si invita a sollecitare un Erogatore ad attivare un simile E-service e, una volta attivato, si invita a inviare una richiesta di accesso per quell’E-Service",
      },
      options: [
        {
          label: {
    ...
    },
    {
      ...
      label: {
        ...
        en: "Indicare se si intende fruire dell’E-service, anche o esclusivamente, per accedere a dati su richiesta/per conto di terzi soggetti",
      },
      options: [
        {
          label: {
    ...
    },
    {
      ...
      label: {
        ...
        en: "Indicare se si intende fruire dell’e-service per accedere a dati",
      },
      options: [
        {
          label: {
            it: "Esclusivamente per conto di un soggetto di cui all’art. 2, comma 2, lett. a) del CAD",
            en: "Esclusivamente per conto di un soggetto di cui all’art. 2, comma 2, lett. a) del CAD",
          },
          value: "PA_ONLY",
        },
        {
          label: {
            ...
            en: "Anche per conto di un soggetto di cui all’art. 2, comma 2, lett. a) del CAD",
          },
          value: "PA_ALSO",
        },
      ],
