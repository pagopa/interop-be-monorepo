...
describe("API POST /agreements/:agreementId/approve", () => {
  const mockApiAgreement = getMockBffApiAgreement();

  beforeEach(() => {
    services.agreementService.approveAgreement = vi
      .fn()
...
describe("API POST /agreements/:agreementId/unsuspend", () => {
  const mockApiAgreement = getMockBffApiAgreement();

  beforeEach(() => {
    services.agreementService.unsuspendAgreement = vi
      .fn()
      .mockResolvedValue(mockApiAgreement);
  });
