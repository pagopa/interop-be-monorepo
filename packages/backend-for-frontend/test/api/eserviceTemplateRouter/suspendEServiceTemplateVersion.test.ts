...
describe("API POST /eservices/templates/:eServiceTemplateId/versions/:eServiceTemplateVersionId/suspend", () => {
  beforeEach(() => {
    clients.eserviceTemplateProcessClient.suspendTemplateVersion = vi
      .fn()
  ...
  const makeRequest = async (
    ...
    request(api)
      .post(
        `${appBasePath}/eservices/templates/${eServiceTemplateId}/versions/${eServiceTemplateVersionId}/suspend`
      )
