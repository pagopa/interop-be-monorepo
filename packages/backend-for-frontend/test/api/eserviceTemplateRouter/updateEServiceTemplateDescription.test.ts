...
describe("API POST /eservices/templates/:eServiceTemplateId/description/update", () => {
  ...
  beforeEach(() => {
    clients.eserviceTemplateProcessClient.updateEServiceTemplateDescription = vi
      .fn()
  ...
  const makeRequest = async (
    ...
    body: bffApi.EServiceTemplateDescriptionUpdateSeed = mockEServiceTemplateDescriptionUpdateSeed
  ) =>
    request(api)
      .post(
        `${appBasePath}/eservices/templates/${eServiceTemplateId}/description/update`
      )
  ...
  it.each([
    ...
    {
      body: {
        ...mockEServiceTemplateDescriptionUpdateSeed,
        extraField: 1,
      },
    },
  ])(
    ...
    async ({ eServiceTemplateId, body }) => {
      ...
      const res = await makeRequest(
        token,
        eServiceTemplateId,
        body as bffApi.EServiceTemplateDescriptionUpdateSeed
      );
