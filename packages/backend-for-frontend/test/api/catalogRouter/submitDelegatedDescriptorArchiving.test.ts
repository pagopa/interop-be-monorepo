...
describe("API POST /eservices/:eServiceId/descriptors/:descriptorId/submitDelegatedArchiving", () => {
  beforeEach(() => {
    clients.catalogProcessClient.submitDelegatedDescriptorArchiving = vi
      .fn()
