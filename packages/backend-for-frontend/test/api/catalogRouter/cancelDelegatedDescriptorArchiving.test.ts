...
describe("API DELETE /eservices/:eServiceId/descriptors/:descriptorId/submitDelegatedArchiving", () => {
  beforeEach(() => {
    clients.catalogProcessClient.cancelDelegatedDescriptorArchiving = vi
      .fn()
