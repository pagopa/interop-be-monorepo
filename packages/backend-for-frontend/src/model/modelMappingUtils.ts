...
export const notificationTypeToUiSection: Record<NotificationType, UiSection> =
  {
    ...
    eserviceArchivingRequestSubmittedToDelegator: "/aderente/deleghe",
    eserviceArchivingRequestApprovedRejectedToDelegate: "/aderente/deleghe",
...
export const notificationTypeToCategory: Record<NotificationType, Category> = {
  ...
  eserviceArchivingRequestSubmittedToDelegator: "Delegations",
  eserviceArchivingRequestApprovedRejectedToDelegate: "Delegations",
