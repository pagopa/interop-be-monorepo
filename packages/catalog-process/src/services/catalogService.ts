...
async function innerCreateEService(
  {
    ...
    // supplied by the eservice import, where the id is generated by the caller
    eserviceId?: EServiceId;
  },
  readModelService: ReadModelServiceSQL,
  {
  ...
  const newEserviceId = eserviceId ?? generateId<EServiceId>();
  assertValidDelegationFlags(
  ...
  if (
    ...
    throw asyncExchangeNotAllowedForReceiveMode(newEserviceId);
  }
