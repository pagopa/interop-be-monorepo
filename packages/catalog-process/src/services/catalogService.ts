...
export function catalogServiceBuilder(
  ...
  return {
    ...
    async scheduleEServiceDescriptorArchiving(
      ...
      const updatedEService = await scheduleEServiceDescriptorArchivingLogic(eservice.data, descriptor, authData, readModelService);
...
async function scheduleEServiceDescriptorArchivingLogic(
  eservice: EService,
  descriptor: Descriptor,
  authData: UIAuthData | M2MAdminAuthData,
  readModelService: ReadModelServiceSQL,
