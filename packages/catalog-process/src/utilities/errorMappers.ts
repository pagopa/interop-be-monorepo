...
export const updateEServiceInstanceLabelErrorMapper = (
  error: ApiError<ErrorCodes>
): number =>
  match(error.code)
    .with(
...
export const cancelDelegatedEServiceArchivingErrorMapper = (
  error: ApiError<ErrorCodes>
): number =>
  match(error.code)
    .with(
...
export const internalDeleteDelegatedPendingDescriptorErrorMapper = (
  error: ApiError<ErrorCodes>
): number =>
  match(error.code)
    .with(
