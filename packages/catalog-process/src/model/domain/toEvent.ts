...
export const toCreateEventMaintenanceEServiceRiskAnalysisSetTenantKind = (
  streamId: string,
  version: number,
  riskAnalysisId: RiskAnalysisId,
  eservice: EService,
...
export const toCreateEventEServiceAsyncExchangeCallbackInterfaceAdded = (
  streamId: string,
  version: number,
  {
    descriptorId,
...
export const toCreateEventEServicePendingDescriptorDeletedOnRevoke = (
  version: number,
  descriptorId: DescriptorId,
  eservice: EService,
  correlationId: CorrelationId
...
export const toCreateEventEServiceDeletedOnRevoke = (
  version: number,
  eservice: EService,
  correlationId: CorrelationId
): CreateEvent<EServiceEvent> => ({
