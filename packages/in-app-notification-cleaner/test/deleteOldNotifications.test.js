...
import { addNotifications, getMockNotification, inAppNotificationDB, } from "./utils.js";
describe("deleteOldNotifications", () => {
    ...
    it("should delete notifications older than specified days", async () => {
        ...
        const deletedCount = await deleteOldNotifications(inAppNotificationDB, 90, loggerInstance);
    ...
    it("should respect custom retention period", async () => {
        ...
        const deletedCount = await deleteOldNotifications(inAppNotificationDB, 45, loggerInstance);
        expect(deletedCount).toBe(2);
        const remainingNotifications = await inAppNotificationDB
            .select()
            .from(notification);
