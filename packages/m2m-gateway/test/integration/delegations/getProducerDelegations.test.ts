...
describe("getProducerDelegations", () => {
  const mockParams: m2mGatewayApi.GetProducerDelegationsQueryParams = {
  ...
  it("Should succeed and perform API clients calls", async () => {
    const m2mDelegationResponse1: m2mGatewayApi.ProducerDelegation = {
    ...
    const m2mDelegationResponse2: m2mGatewayApi.ProducerDelegation = {
    ...
    const m2mDelegationsResponse: m2mGatewayApi.ProducerDelegations = {
      pagination: {
