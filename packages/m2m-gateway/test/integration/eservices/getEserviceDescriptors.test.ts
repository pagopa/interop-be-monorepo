...
describe("getEserviceDescriptors", () => {
  ...
  const m2mEserviceDescriptorResponse2: m2mGatewayApi.EServiceDescriptor =
    testToM2MGatewayApiDescriptor(mockCatalogProcessDescriptor2);
  const m2mEserviceDescriptorResponse3: m2mGatewayApi.EServiceDescriptor =
    testToM2MGatewayApiDescriptor(mockCatalogProcessDescriptor3);
  const m2mEserviceDescriptorResponse4: m2mGatewayApi.EServiceDescriptor =
    testToM2MGatewayApiDescriptor(mockCatalogProcessDescriptor4);
  const m2mEserviceDescriptorResponse5: m2mGatewayApi.EServiceDescriptor =
  ...
  it("Should succeed and perform API clients calls", async () => {
    const m2mEserviceDescriptorsResponse: m2mGatewayApi.EServiceDescriptors = {
      pagination: {
        offset: 0,
        limit: 10,
  ...
  it("Should apply filters (offset, limit)", async () => {
    const m2mEserviceDescriptorsResponse1: m2mGatewayApi.EServiceDescriptors = {
      pagination: {
        offset: 0,
        limit: 2,
        totalCount: mockCatalogProcessResponse.data.descriptors.length,
