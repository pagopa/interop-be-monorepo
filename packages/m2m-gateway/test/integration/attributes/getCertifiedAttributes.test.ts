...
describe("getCertifiedAttributes integration", () => {
  ...
  it("Should succeed and perform API clients calls", async () => {
    const m2mAttributesResponse: m2mGatewayApi.CertifiedAttributes = {
      pagination: {
        limit: 10,
        offset: 0,
        totalCount: 3,
  ...
  it("Should apply filters (offset, limit)", async () => {
    ...
    const m2mCertifiedAttributesResponse1: m2mGatewayApi.CertifiedAttributes = {
      pagination: {
        offset: 0,
        limit: 2,
        totalCount: 3,
    ...
    const m2mCertifiedAttributesResponse2: m2mGatewayApi.CertifiedAttributes = {
      pagination: {
        offset: 2,
        limit: 2,
        totalCount: 3,
  ...
  it("Should handle empty results", async () => {
    ...
    const m2mEmptyResponse: m2mGatewayApi.CertifiedAttributes = {
      pagination: {
        offset: 0,
        limit: 10,
        totalCount: 0,
