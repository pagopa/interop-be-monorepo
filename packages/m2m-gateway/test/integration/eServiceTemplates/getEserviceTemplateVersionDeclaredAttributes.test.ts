...
describe("getEserviceTemplateVersionDeclaredAttributes", () => {
  ...
  const response: m2mGatewayApi.EServiceTemplateVersionDeclaredAttribute[] = [
    {
      groupIndex: 0,
  ...
  it("Should apply filters (offset, limit)", async () => {
    const response1: m2mGatewayApi.EServiceTemplateVersionDeclaredAttributes = {
      pagination: {
        offset: 0,
        limit: 2,
        totalCount: 3,
    ...
    const response2: m2mGatewayApi.EServiceTemplateVersionDeclaredAttributes = {
      pagination: {
        offset: 2,
        limit: 2,
        totalCount: 3,
  ...
  it("Should throw eserviceTemplateVersionAttributeNotFound in case an attribute ID is present but cannot be resolved by the Attribute Registry", async () => {
    ...
    const descriptorWithMissingAttribute: eserviceTemplateApi.EServiceTemplateVersion = {
      ...
      attributes: {
        certified: [],
        declared: [[{ id: MISSING_ATTRIBUTE_ID, explicitAttributeVerification: false }]],
        verified: [],
      },
    };
