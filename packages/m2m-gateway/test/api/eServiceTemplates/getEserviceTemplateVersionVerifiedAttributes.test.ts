...
describe("GET /eserviceTemplates/{templateId}/versions/{versionId}/verifiedAttributes router test", () => {
  ...
  const results: m2mGatewayApi.EServiceTemplateVersionVerifiedAttribute[] = [
    {
      groupIndex: 0,
  ...
  const mockM2MEserviceTemplateVersionVerifiedAttributesResponse: m2mGatewayApi.EServiceTemplateVersionVerifiedAttributes =
  {
    pagination: { offset: 0, limit: 10, totalCount: 3 },
    results,
  };

  const mockQueryParams: m2mGatewayApi.GetEServiceTemplateVersionVerifiedAttributesQueryParams = {
    offset: 0,
    limit: 10,
  };

  mockEServiceTemplateService.getEserviceTemplateVersionVerifiedAttributes = vi
    .fn()
    .mockResolvedValue(
      mockM2MEserviceTemplateVersionVerifiedAttributesResponse
    );
  ...
  const makeRequest = async (
    ...
    query: m2mGatewayApi.GetEServiceTemplateVersionVerifiedAttributesQueryParams = mockQueryParams
  ) =>
    request(api)
      .get(
        `${appBasePath}/eserviceTemplates/${templateId}/versions/${versionId}/verifiedAttributes`
      )
  ...
  it.each([
    ...
    async ({ error, expectedStatus }) => {
      mockEServiceTemplateService.getEserviceTemplateVersionVerifiedAttributes =
  ...
  it.each([
    ...
    const res = await makeRequest(
      ...
      generateId(),
      generateId(),
      query as m2mGatewayApi.GetEServiceTemplateVersionVerifiedAttributesQueryParams
    );
