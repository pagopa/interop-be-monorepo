...
describe("GET /eserviceTemplates/{templateId}/versions/{versionId}/verifiedAttributes router test", () => {
  ...
  mockEServiceTemplateService.getEserviceTemplateVersionVerifiedAttributes = vi
    .fn()
    .mockResolvedValue(mockM2MEserviceTemplateVersionVerifiedAttributesResponse);
  ...
  it.each(authorizedRoles)(
    ...
    async (role) => {
      ...
      expect(res.body).toEqual(mockM2MEserviceTemplateVersionVerifiedAttributesResponse);
    }
  );
  ...
  it.each([
    {
      ...
      results: [
        {
          ...mockM2MEserviceTemplateVersionVerifiedAttributesResponse.results[0],
          id: "invalid",
        },
      ],
    },
