...
describe("POST /eserviceTemplates/:templateId/versions/:versionId/verifiedAttributes/groups router test", () => {
  ...
  const mockResponse: m2mGatewayApi.EServiceTemplateVersionVerifiedAttribute[] =
    [
      {
        groupIndex: 1,
  ...
  const makeRequest = async (
    ...
    request(api)
      .post(
        `${appBasePath}/eserviceTemplates/${templateId}/versions/${versionId}/verifiedAttributes/groups`
      )
  ...
  it.each(authorizedRoles)(
    ...
    async (role) => {
      mockEServiceTemplateService.createEServiceTemplateVersionVerifiedAttributesGroup =
