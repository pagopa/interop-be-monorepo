...
describe("PATCH /reversePurposes/:purposeId router test", () => {
  ...
  const mockUpdateSeed: m2mGatewayApi.ReversePurposeDraftUpdateSeed = {
    title: "updated title",
  ...
  const makeRequest = async (
    ...
    body: m2mGatewayApi.ReversePurposeDraftUpdateSeed = mockUpdateSeed
  ) =>
    request(api)
  ...
  it.each([
    ...
    async (seed: m2mGatewayApi.ReversePurposeDraftUpdateSeed) => {
  ...
  it.each([
    ...
    const res = await makeRequest(
      token,
      mockPurpose.id,
      seed as m2mGatewayApi.ReversePurposeDraftUpdateSeed
    );
