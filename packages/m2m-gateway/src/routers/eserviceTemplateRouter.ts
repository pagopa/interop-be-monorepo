  ...
  eserviceTemplateRouter
      ...
      async (req, res) => {
        ...
        try {
          ...
          return res
            .status(201)
            .send(
              m2mGatewayApi.EServiceTemplateVersionCertifiedAttributesGroup.parse(
                attributes
              )
            );
        } catch (error) {
      ...
      async (req, res) => {
        ...
        try {
          ...
          return res
            .status(201)
            .send(
              m2mGatewayApi.EServiceTemplateVersionDeclaredAttributesGroup.parse(
                attributes
              )
            );
        } catch (error) {
      ...
      async (req, res) => {
        ...
        try {
          ...
          return res
            .status(201)
            .send(
              m2mGatewayApi.EServiceTemplateVersionVerifiedAttributesGroup.parse(
                attributes
              )
            );
        } catch (error) {
    ...
    .post("/eserviceTemplates/:templateId/eservices", async (req, res) => {
      ...
      try {
        ...
        const eservice =
          await eserviceTemplateService.createEServiceInstanceFromTemplate(
            unsafeBrandId(req.params.templateId),
            req.body,
            ctx
          );
    ...
    .post("/eserviceTemplates/eservices/:eserviceId", async (req, res) => {
      ...
      try {
        ...
        const eservice =
          await eserviceTemplateService.updateEServiceTemplateInstance(
    ...
    .post(
      ...
      async (req, res) => {
        ...
        try {
          ...
          const eservice =
            await eserviceTemplateService.updateEServiceTemplateInstanceLabel(
              unsafeBrandId(req.params.eserviceId),
              req.body,
              ctx
            );
    ...
    .post(
      ...
      async (req, res) => {
        ...
        try {
          ...
          const descriptor =
            await eserviceTemplateService.createTemplateInstanceDescriptor(
              unsafeBrandId(req.params.eserviceId),
              req.body,
              ctx
            );
    ...
    .post(
      ...
      async (req, res) => {
        ...
        try {
          ...
          const descriptor =
            await eserviceTemplateService.updateDraftDescriptorTemplateInstance(
              unsafeBrandId(req.params.eserviceId),
    ...
    .post(
      ...
      async (req, res) => {
        ...
        try {
          ...
          const descriptor =
            await eserviceTemplateService.updateTemplateInstanceDescriptorQuotas(
              unsafeBrandId(req.params.eserviceId),
              unsafeBrandId(req.params.descriptorId),
              req.body,
              ctx
