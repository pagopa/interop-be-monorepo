...
import { InAppNotificationService } from "../src/services/inAppNotificationService.js";

export const inAppNotificationService = {} as InAppNotificationService;

export const api = await createApp(inAppNotificationService);
