...
describe("getClients", () => {
  const mockParams: m2mGatewayApiV3.GetClientsQueryParams = {
  ...
  it("Should succeed with full clients and perform API clients calls", async () => {
    ...
    const m2mClientResponse1: m2mGatewayApiV3.FullClient = {
    ...
    const m2mClientResponse2: m2mGatewayApiV3.FullClient = {
    ...
    const m2mClientsResponse: m2mGatewayApiV3.Clients = {
      pagination: {
  ...
  it("Should succeed with partial clients and perform API clients calls", async () => {
    ...
    const m2mClientResponse1: m2mGatewayApiV3.PartialClient = {
      id: mockPartialClient1.id,
      consumerId: mockPartialClient1.consumerId,
    };
    const m2mClientResponse2: m2mGatewayApiV3.PartialClient = {
