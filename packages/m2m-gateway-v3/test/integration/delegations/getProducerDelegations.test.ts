...
describe("getProducerDelegations", () => {
  const mockParams: m2mGatewayApiV3.GetProducerDelegationsQueryParams = {
  ...
  it("Should succeed and perform API clients calls", async () => {
    const m2mDelegationResponse1: m2mGatewayApiV3.ProducerDelegation = {
    ...
    const m2mDelegationResponse2: m2mGatewayApiV3.ProducerDelegation = {
    ...
    const m2mDelegationsResponse: m2mGatewayApiV3.ProducerDelegations = {
      pagination: {
    ...
    const result = await delegationService.getProducerDelegations(
      mockParams,
  ...
  it("Should throw unexpectedDelegationKind in case the returned delegation has an unexpected kind", async () => {
    ...
    await expect(
      delegationService.getProducerDelegations(
        mockParams,
        getMockM2MAdminAppContext()
      )
