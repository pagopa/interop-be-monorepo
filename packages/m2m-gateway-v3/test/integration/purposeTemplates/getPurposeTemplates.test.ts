...
describe("getPurposeTemplates", () => {
  const mockParams: m2mGatewayApiV3.GetPurposeTemplatesQueryParams = {
    offset: 0,
    limit: 10,
    eserviceIds: [],
    creatorIds: [],
  ...
  it("Should succeed and perform API clients calls", async () => {
    const expectedM2MPurposeTemplate1: m2mGatewayApiV3.PurposeTemplate = {
    ...
    const expectedM2MPurposeTemplate2: m2mGatewayApiV3.PurposeTemplate = {
    ...
    const m2mPurposeTemplatesResponse: m2mGatewayApiV3.PurposeTemplates = {
      pagination: {
