...
describe("getEserviceDescriptorVerifiedAttributes", () => {
  ...
  const descriptor: catalogApi.EServiceDescriptor = {
    ...
    attributes: {
      ...
      certified: [[attribute4, attribute5]],
      declared: [[attribute6]],
    },
  };
  ...
  const response: m2mGatewayApiV3.EServiceDescriptorVerifiedAttribute[] = [
    {
      groupIndex: 0,
  ...
  it("Should apply filters (offset, limit)", async () => {
    const response1: m2mGatewayApiV3.EServiceDescriptorVerifiedAttributes = {
      pagination: {
        offset: 0,
        limit: 2,
        totalCount: 3,
    ...
    const response2: m2mGatewayApiV3.EServiceDescriptorVerifiedAttributes = {
      pagination: {
        offset: 2,
        limit: 2,
        totalCount: 3,
