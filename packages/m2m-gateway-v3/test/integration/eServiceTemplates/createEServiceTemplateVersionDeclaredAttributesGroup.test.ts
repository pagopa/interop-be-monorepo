...
describe("createEServiceTemplateVersionDeclaredAttributesGroup", () => {
  ...
  const response: m2mGatewayApiV3.EServiceTemplateVersionDeclaredAttributesGroup =
    {
      attributes: [
        {
          groupIndex: 1,
  ...
  it("Should succeed and perform API clients calls", async () => {
    const result =
      await eserviceTemplateService.createEServiceTemplateVersionDeclaredAttributesGroup(
