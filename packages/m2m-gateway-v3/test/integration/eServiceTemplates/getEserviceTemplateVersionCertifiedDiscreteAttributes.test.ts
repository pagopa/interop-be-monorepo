...
describe("getEserviceTemplateVersionCertifiedDiscreteAttributes", () => {
  ...
  const response: m2mGatewayApiV3.EServiceTemplateVersionCertifiedDiscreteAttribute[] =
    [
      {
        groupIndex: 0,
  ...
  it("Should apply filters (offset, limit)", async () => {
    const response1: m2mGatewayApiV3.EServiceTemplateVersionCertifiedDiscreteAttributes =
      {
        pagination: {
          offset: 0,
          limit: 2,
    ...
    const response2: m2mGatewayApiV3.EServiceTemplateVersionCertifiedDiscreteAttributes =
      {
        pagination: {
          offset: 2,
          limit: 2,
  ...
  it("Should throw eserviceTemplateVersionNotFound in case the returned eserviceTemplate has no version with the given id", async () => {
    ...
    await expect(
      eserviceTemplateService.getEserviceTemplateVersionCertifiedDiscreteAttributes(
        unsafeBrandId(eserviceTemplate.id),
