...
describe("getAgreements", () => {
  ...
  it("Should succeed and perform API clients calls", async () => {
    const m2mAgreementResponse1: m2mGatewayApiV3.Agreement = {
    ...
    const m2mAgreementResponse2: m2mGatewayApiV3.Agreement = {
    ...
    const m2mAgreementsResponse: m2mGatewayApiV3.Agreements = {
      pagination: {
