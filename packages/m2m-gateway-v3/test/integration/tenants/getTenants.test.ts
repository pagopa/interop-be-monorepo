...
describe("getTenants", () => {
  const mockParams: m2mGatewayApiV3.GetTenantsQueryParams = {
    taxCode: undefined,
    IPACode: undefined,
    offset: 0,
    limit: 10,
  ...
  it("Should succeed and perform API clients calls", async () => {
    const m2mTenantResponse1: m2mGatewayApiV3.Tenant = {
    ...
    const m2mTenantResponse2: m2mGatewayApiV3.Tenant = {
    ...
    const m2mTenantsResponse: m2mGatewayApiV3.Tenants = {
      pagination: {
  ...
  it("Should throw taxCodeAndIPACodeConflict if both IPACode and taxCode are provided", async () => {
    const params: m2mGatewayApiV3.GetTenantsQueryParams = {
      IPACode: "IPA123",
      taxCode: "TAX123",
      offset: 0,
      limit: 10,
