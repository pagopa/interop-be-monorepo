...
describe("POST /tenants/:tenantId/verifiedAttributes router test", () => {
  ...
  const mockSeed: m2mGatewayApiV3.TenantVerifiedAttributeSeed = {
    id: generateId(),
  ...
  const makeRequest = async (
    token: string,
    body: m2mGatewayApiV3.TenantVerifiedAttributeSeed = mockSeed,
  ...
  ] as m2mGatewayApiV3.TenantVerifiedAttributeSeed[])(
