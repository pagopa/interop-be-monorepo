...
describe("POST /tenants/:tenantId/declaredAttributes router test", () => {
  ...
  const mockSeed: m2mGatewayApiV3.TenantDeclaredAttributeSeed = {
    id: generateId(),
  };

  const makeRequest = async (
    token: string,
    body: m2mGatewayApiV3.TenantDeclaredAttributeSeed = mockSeed,
  ...
  ] as m2mGatewayApiV3.TenantDeclaredAttributeSeed[])(
