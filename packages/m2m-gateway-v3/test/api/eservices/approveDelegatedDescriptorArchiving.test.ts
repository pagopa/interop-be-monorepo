...
describe("POST /eservices/:eserviceId/descriptors/:descriptorId/approveDelegatedArchiving router test", () => {
  ...
  it.each(authorizedRoles)(
    ...
    async (role) => {
      mockEserviceService.approveDelegatedDescriptorArchiving = vi
        .fn()
      ...
      expect(
        mockEserviceService.approveDelegatedDescriptorArchiving
