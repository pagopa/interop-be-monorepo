...
describe("DELETE /eservices/{eserviceId}/descriptors/{descriptorId}/verifiedAttributes/groups/{groupIndex}/attributes/{attributeId} router test", () => {
  ...
  const makeRequest = async (
    ...
    request(api)
      .delete(
        `${appBasePath}/eservices/${eserviceId}/descriptors/${descriptorId}/verifiedAttributes/groups/${groupIndex}/attributes/${attributeId}`
      )
  ...
  it.each(authorizedRoles)(
    ...
    async (role) => {
      mockEserviceService.deleteEServiceDescriptorVerifiedAttributeFromGroup =
        vi.fn();
