...
describe("PATCH /eservices/:eserviceId/descriptors/:descriptorId/quotas router test", () => {
  ...
  const makeRequest = async (
    ...
    body: m2mGatewayApiV3.EServiceDescriptorQuotasUpdateSeed = mockSeed
  ) =>
    request(api)
      .patch(
  ...
  it.each([
    ...
    {},
  ] satisfies m2mGatewayApiV3.EServiceDescriptorQuotasUpdateSeed[])(
  ...
  it.each([
    ...
    const res = await makeRequest(
      ...
      mockEService.id,
      mockDescriptor.id,
      seed as m2mGatewayApiV3.EServiceDescriptorQuotasUpdateSeed
    );
