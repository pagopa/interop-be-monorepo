...
describe("PATCH /eservices/{eServiceId}/descriptors/{descriptorId} router test", () => {
  ...
  const makeRequest = async (
    ...
    body: m2mGatewayApiV3.EServiceDescriptorDraftUpdateSeed = descriptorSeed
  ) =>
    request(api)
      .patch(
  ...
  ] as m2mGatewayApiV3.EServiceDescriptorDraftUpdateSeed[])(
  ...
  it.each([
    ...
    async (body) => {
      ...
      const res = await makeRequest(
        ...
        generateId(),
        generateId(),
        body as m2mGatewayApiV3.EServiceDescriptorDraftUpdateSeed
      );
