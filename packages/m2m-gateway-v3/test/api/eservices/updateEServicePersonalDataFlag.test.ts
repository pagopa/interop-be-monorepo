...
describe("POST /eservices/:eserviceId/personalDataFlag router test", () => {
  ...
  const mockSeed: m2mGatewayApiV3.EServicePersonalDataFlagUpdateSeed = {
  ...
  const makeRequest = async (
    ...
    body: m2mGatewayApiV3.EServicePersonalDataFlagUpdateSeed = mockSeed
  ) =>
    request(api)
  ...
  it.each([
    ...
    const res = await makeRequest(
      token,
      mockEService.id,
      seed as m2mGatewayApiV3.EServicePersonalDataFlagUpdateSeed
    );
