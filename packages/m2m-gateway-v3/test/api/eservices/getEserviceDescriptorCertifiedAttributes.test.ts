...
describe("GET /eservices/{eServiceId}/descriptors/{descriptorId}/certifiedAttributes router test", () => {
  ...
  const bulkAttribute2: m2mGatewayApiV3.CertifiedAttribute = {
    code: "code2",
    id: attribute2.id,
  ...
  const bulkAttribute3: m2mGatewayApiV3.CertifiedAttribute = {
    code: "code3",
    id: attribute3.id,
  ...
  const results: m2mGatewayApiV3.EServiceDescriptorCertifiedAttribute[] = [
    {
      groupIndex: 0,
  ...
  const mockM2MEserviceCertifiedAttributesResponse: m2mGatewayApiV3.EServiceDescriptorCertifiedAttributes =
    {
  ...
  const makeRequest = async (
    ...
    query: m2mGatewayApiV3.GetCertifiedAttributesQueryParams = mockQueryParams
  ) =>
    request(api)
      .get(
  ...
  it.each([
    ...
    const res = await makeRequest(
      ...
      generateId(),
      generateId(),
      query as m2mGatewayApiV3.GetCertifiedAttributesQueryParams
    );
