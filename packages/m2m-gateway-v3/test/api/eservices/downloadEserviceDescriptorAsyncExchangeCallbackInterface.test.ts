...
describe("GET /eservices/:eserviceId/descriptors/:descriptorId/asyncExchangeCallbackInterface router test", () => {
  ...
  it.each(authorizedRoles)(
    ...
    async (role) => {
      mockEserviceService.downloadEServiceDescriptorAsyncExchangeCallbackInterface =
