...
describe("POST /eservices/:eserviceId/approveDelegatedArchiving router test", () => {
  ...
  it.each(authorizedRoles)(
    ...
    async (role) => {
      mockEserviceService.approveDelegatedEServiceArchiving = vi
        .fn()
      ...
      expect(
        mockEserviceService.approveDelegatedEServiceArchiving
