...
describe("DELETE /producerKeychains/:producerKeychainId/users/:userId router test", () => {
  ...
  it.each(authorizedRoles)(
    ...
    async (role) => {
      ...
      mockProducerKeychainService.removeProducerKeychainUser = vi.fn();
  ...
  it.each([
    ...
    mockProducerKeychainService.removeProducerKeychainUser = vi
      .fn()
