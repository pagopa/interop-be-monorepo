...
describe("POST /eserviceTemplates/:templateId/versions/:versionId/certifiedDiscreteAttributes/groups router test", () => {
  ...
  const makeRequest = async (
    ...
    request(api)
      .post(
        `${appBasePath}/eserviceTemplates/${templateId}/versions/${versionId}/certifiedDiscreteAttributes/groups`
      )
  ...
  it.each(authorizedRoles)(
    ...
    async (role) => {
      mockEServiceTemplateService.createEServiceTemplateVersionCertifiedDiscreteAttributesGroup =
