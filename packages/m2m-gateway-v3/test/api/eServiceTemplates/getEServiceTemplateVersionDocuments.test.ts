...
describe("GET /eserviceTemplates/:templateId/descriptor/:versionId/documents route test", () => {
  ...
  const makeRequest = async (
    ...
    query: m2mGatewayApiV3.GetEServiceTemplateVersionDocumentsQueryParams
  ) =>
    request(api)
      .get(
  ...
  it.each([
    ...
    const res = await makeRequest(
      ...
      generateId(),
      generateId(),
      query as unknown as m2mGatewayApiV3.GetEServiceTemplateVersionDocumentsQueryParams
    );
