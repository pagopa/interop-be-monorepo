...
describe("GET /eserviceTemplates/{templateId}/versions/{versionId}/declaredAttributes router test", () => {
  ...
  const bulkAttribute1: m2mGatewayApiV3.DeclaredAttribute = {
    id: attribute1.id,
  ...
  const bulkAttribute2: m2mGatewayApiV3.DeclaredAttribute = {
    id: attribute2.id,
  ...
  const bulkAttribute3: m2mGatewayApiV3.DeclaredAttribute = {
    id: attribute3.id,
  ...
  const results: m2mGatewayApiV3.EServiceTemplateVersionDeclaredAttribute[] = [
    {
      groupIndex: 0,
  ...
  const mockM2MEserviceTemplateVersionDeclaredAttributesResponse: m2mGatewayApiV3.EServiceTemplateVersionDeclaredAttributes =
    {
      pagination: { offset: 0, limit: 10, totalCount: 3 },
      results,
    };

  const mockQueryParams: m2mGatewayApiV3.GetEServiceTemplateVersionDeclaredAttributesQueryParams =
    {
      offset: 0,
      limit: 10,
    };
  ...
  const makeRequest = async (
    ...
    query: m2mGatewayApiV3.GetEServiceTemplateVersionDeclaredAttributesQueryParams = mockQueryParams
  ) =>
    request(api)
      .get(
  ...
  it.each([
    ...
    const res = await makeRequest(
      ...
      generateId(),
      generateId(),
      query as m2mGatewayApiV3.GetEServiceTemplateVersionDeclaredAttributesQueryParams
    );
