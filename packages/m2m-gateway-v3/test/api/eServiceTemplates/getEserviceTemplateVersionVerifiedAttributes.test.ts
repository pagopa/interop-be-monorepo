...
describe("GET /eserviceTemplates/{templateId}/versions/{versionId}/verifiedAttributes router test", () => {
  ...
  const results: m2mGatewayApiV3.EServiceTemplateVersionVerifiedAttribute[] = [
    {
      groupIndex: 0,
  ...
  const mockM2MEserviceTemplateVersionVerifiedAttributesResponse: m2mGatewayApiV3.EServiceTemplateVersionVerifiedAttributes =
  {
    pagination: { offset: 0, limit: 10, totalCount: 3 },
    results,
  };

  const mockQueryParams: m2mGatewayApiV3.GetEServiceTemplateVersionVerifiedAttributesQueryParams =
  {
    offset: 0,
    limit: 10,
  };
  ...
  const makeRequest = async (
    ...
    query: m2mGatewayApiV3.GetEServiceTemplateVersionVerifiedAttributesQueryParams = mockQueryParams
  ) =>
    request(api)
      .get(
  ...
  it.each([
    ...
    const res = await makeRequest(
      ...
      generateId(),
      generateId(),
      query as m2mGatewayApiV3.GetEServiceTemplateVersionVerifiedAttributesQueryParams
    );
