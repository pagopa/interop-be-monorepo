...
describe("GET /eserviceTemplates/{templateId}/versions/{versionId}/certifiedAttributes router test", () => {
  ...
  const results: m2mGatewayApiV3.EServiceTemplateVersionCertifiedAttribute[] = [
    {
      groupIndex: 0,
  ...
  const makeRequest = async (
    ...
    query: m2mGatewayApiV3.GetEServiceTemplateVersionCertifiedAttributesQueryParams = mockQueryParams
  ) =>
    request(api)
      .get(
  ...
  it.each([
    ...
    const res = await makeRequest(
      ...
      generateId(),
      generateId(),
      query as m2mGatewayApiV3.GetEServiceTemplateVersionCertifiedAttributesQueryParams
    );
