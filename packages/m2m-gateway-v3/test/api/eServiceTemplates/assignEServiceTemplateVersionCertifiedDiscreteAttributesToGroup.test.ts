...
describe("POST /eserviceTemplates/{templateId}/versions/{versionId}/certifiedDiscreteAttributes/groups/{groupIndex}/attributes router test", () => {
  ...
  const mockResponse: m2mGatewayApiV3.EServiceTemplateVersionCertifiedDiscreteAttributesGroup =
    {
      attributes: [
        {
          groupIndex: 1,
  ...
  const makeRequest = async (
    ...
    request(api)
      .post(
        `${appBasePath}/eserviceTemplates/${templateId}/versions/${versionId}/certifiedDiscreteAttributes/groups/${groupIndex}/attributes`
      )
  ...
  it.each(authorizedRoles)(
    "Should return 200 and assign certified discrete attributes to group for user with role %s",
    async (role) => {
      mockEServiceTemplateService.assignEServiceTemplateVersionCertifiedDiscreteAttributesToGroup =
