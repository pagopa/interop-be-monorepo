...
describe("POST /eserviceTemplates/:templateId/versions/:versionId/suspend router test", () => {
  ...
  const makeRequest = async (
    ...
    request(api)
      .post(
        `${appBasePath}/eserviceTemplates/${templateId}/versions/${versionId}/suspend`
      )
  ...
  it.each(authorizedRoles)(
    ...
    async (role) => {
      mockEServiceTemplateService.suspendEServiceTemplateVersion = vi
        .fn()
