...
describe("DELETE /eserviceTemplates/{templateId}/versions/{versionId}/declaredAttributes/groups/{groupIndex}/attributes/{attributeId} router test", () => {
  ...
  const makeRequest = async (
    ...
    request(api)
      .delete(
        `${appBasePath}/eserviceTemplates/${templateId}/versions/${versionId}/declaredAttributes/groups/${groupIndex}/attributes/${attributeId}`
      )
  ...
  it.each(authorizedRoles)(
    ...
    async (role) => {
      mockEServiceTemplateService.deleteEServiceTemplateVersionDeclaredAttributeFromGroup =
        vi.fn();
