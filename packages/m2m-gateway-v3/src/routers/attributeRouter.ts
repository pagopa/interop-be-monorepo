...
const attributeRouter = (
  ...
  const attributeRouter = ctx.router(m2mGatewayApiV3.attributesApi.api, {
  ...
  attributeRouter
    .get("/certifiedAttributes/:attributeId", async (req, res) => {
      ...
      try {
        ...
        return res
          .status(200)
          .send(m2mGatewayApiV3.CertifiedAttribute.parse(attribute));
      } catch (error) {
    ...
    .get("/declaredAttributes/:attributeId", async (req, res) => {
      ...
      try {
        ...
        return res
          .status(200)
          .send(m2mGatewayApiV3.DeclaredAttribute.parse(attribute));
      } catch (error) {
        const errorRes = makeApiProblem(
          error,
          getAttributeErrorMapper,
    ...
    .get("/verifiedAttributes/:attributeId", async (req, res) => {
      ...
      try {
        ...
        return res
          .status(200)
          .send(m2mGatewayApiV3.VerifiedAttribute.parse(attribute));
      } catch (error) {
        const errorRes = makeApiProblem(
          error,
          getAttributeErrorMapper,
    ...
    .get("/certifiedAttributes", async (req, res) => {
      ...
      try {
        ...
        return res
          .status(200)
          .send(m2mGatewayApiV3.CertifiedAttributes.parse(attributes));
      } catch (error) {
        const errorRes = makeApiProblem(
          error,
          emptyErrorMapper,
    ...
    .get("/declaredAttributes", async (req, res) => {
      ...
      try {
        ...
        return res
          .status(200)
          .send(m2mGatewayApiV3.DeclaredAttributes.parse(attributes));
      } catch (error) {
        const errorRes = makeApiProblem(
          error,
          emptyErrorMapper,
    ...
    .get("/verifiedAttributes", async (req, res) => {
      ...
      try {
        ...
        return res
          .status(200)
          .send(m2mGatewayApiV3.VerifiedAttributes.parse(attributes));
      } catch (error) {
        const errorRes = makeApiProblem(
          error,
          emptyErrorMapper,
