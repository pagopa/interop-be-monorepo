...
const eserviceTemplateRouter = (
  ...
  const eserviceTemplateRouter = ctx.router(
    m2mGatewayApiV3.eserviceTemplatesApi.api,
    {
  ...
  eserviceTemplateRouter
    .get("/eserviceTemplates", async (req, res) => {
      ...
      try {
        ...
        return res
          .status(200)
          .send(m2mGatewayApiV3.EServiceTemplates.parse(templates));
      } catch (error) {
    ...
    .post("/eserviceTemplates", async (req, res) => {
      ...
      try {
        ...
        return res
          .status(201)
          .send(m2mGatewayApiV3.EServiceTemplate.parse(template));
      } catch (error) {
        const errorRes = makeApiProblem(
          error,
          emptyErrorMapper,
    ...
    .patch("/eserviceTemplates/:templateId", async (req, res) => {
      ...
      try {
        ...
        return res
          .status(200)
          .send(m2mGatewayApiV3.EServiceTemplate.parse(eserviceTemplate));
      } catch (error) {
        const errorRes = makeApiProblem(
          error,
          emptyErrorMapper,
    ...
    .get("/eserviceTemplates/:templateId/versions", async (req, res) => {
      ...
      try {
        ...
        return res
          .status(200)
          .send(m2mGatewayApiV3.EServiceTemplateVersions.parse(versions));
      } catch (error) {
        const errorRes = makeApiProblem(
          error,
          emptyErrorMapper,
    ...
    .patch(
      ...
      async (req, res) => {
        ...
        try {
          ...
          return res
            .status(200)
            .send(m2mGatewayApiV3.EServiceTemplateVersion.parse(version));
        } catch (error) {
          const errorRes = makeApiProblem(
            error,
            emptyErrorMapper,
      ...
      async (req, res) => {
        ...
        try {
          ...
          return res
            .status(200)
            .send(
              m2mGatewayApiV3.EServiceTemplateVersionCertifiedAttributes.parse(
                attributes
              )
            );
        } catch (error) {
    ...
    .post(
      ...
      async (req, res) => {
        ...
        try {
          validateAuthorization(ctx, [M2M_ADMIN_ROLE]);
          const attributes =
            await eserviceTemplateService.createEServiceTemplateVersionCertifiedAttributesGroup(
              unsafeBrandId(req.params.templateId),
              unsafeBrandId(req.params.versionId),
              req.body,
              ctx
          ...
          return res
            .status(201)
            .send(
              m2mGatewayApiV3.EServiceTemplateVersionCertifiedAttributesGroup.parse(
                attributes
              )
            );
        } catch (error) {
      ...
      async (req, res) => {
        ...
        try {
          ...
          return res
            .status(200)
            .send(
              m2mGatewayApiV3.EServiceTemplateVersionDeclaredAttributes.parse(
                attributes
              )
            );
        } catch (error) {
      ...
      async (req, res) => {
        ...
        try {
          ...
          return res
            .status(201)
            .send(
              m2mGatewayApiV3.EServiceTemplateVersionDeclaredAttributesGroup.parse(
                attributes
              )
            );
        } catch (error) {
      ...
      async (req, res) => {
        ...
        try {
          ...
          return res
            .status(200)
            .send(
              m2mGatewayApiV3.EServiceTemplateVersionVerifiedAttributes.parse(
                attributes
              )
            );
        } catch (error) {
      ...
      async (req, res) => {
        ...
        try {
          ...
          return res
            .status(201)
            .send(
              m2mGatewayApiV3.EServiceTemplateVersionVerifiedAttributesGroup.parse(
                attributes
              )
            );
        } catch (error) {
      ...
      async (req, res) => {
        ...
        try {
          ...
          const errorRes = makeApiProblem(
            ...
            assignEServiceTemplateVersionAttributesErrorMapper,
            ctx,
            `Error assigning declared attributes to version with id ${req.params.versionId} for eservice template with id ${req.params.templateId}`
          );
          return res.status(errorRes.status).send(errorRes);
        }
      }
