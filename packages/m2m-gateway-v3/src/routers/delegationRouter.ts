...
const delegationRouter = (
  ...
  const delegationRouter = ctx.router(m2mGatewayApiV3.delegationsApi.api, {
  ...
  delegationRouter
    .get("/consumerDelegations", async (req, res) => {
      ...
      try {
        ...
        return res
          .status(200)
          .send(m2mGatewayApiV3.ConsumerDelegations.parse(consumerDelegations));
      } catch (error) {
    ...
    .get("/consumerDelegations/:delegationId", async (req, res) => {
      ...
      try {
        ...
        return res
          .status(200)
          .send(m2mGatewayApiV3.ConsumerDelegation.parse(consumerDelegation));
      } catch (error) {
        const errorRes = makeApiProblem(
          error,
          emptyErrorMapper,
    ...
    .post("/consumerDelegations", async (req, res) => {
      ...
      try {
        ...
        return res
          .status(201)
          .send(m2mGatewayApiV3.ConsumerDelegation.parse(createdDelegation));
      } catch (error) {
        const errorRes = makeApiProblem(
          error,
          emptyErrorMapper,
    ...
    .post("/consumerDelegations/:delegationId/accept", async (req, res) => {
      ...
      try {
        ...
        return res
          .status(200)
          .send(m2mGatewayApiV3.ConsumerDelegation.parse(acceptedDelegation));
      } catch (error) {
        const errorRes = makeApiProblem(
          error,
          emptyErrorMapper,
    ...
    .post("/consumerDelegations/:delegationId/reject", async (req, res) => {
      ...
      try {
        ...
        return res
          .status(200)
          .send(m2mGatewayApiV3.ConsumerDelegation.parse(rejectedDelegation));
      } catch (error) {
        const errorRes = makeApiProblem(
          error,
          emptyErrorMapper,
    ...
    .get("/producerDelegations", async (req, res) => {
      ...
      try {
        ...
        return res
          .status(200)
          .send(m2mGatewayApiV3.ProducerDelegations.parse(producerDelegations));
      } catch (error) {
        const errorRes = makeApiProblem(
          error,
          emptyErrorMapper,
    ...
    .get("/producerDelegations/:delegationId", async (req, res) => {
      ...
      try {
        ...
        return res
          .status(200)
          .send(m2mGatewayApiV3.ProducerDelegation.parse(producerDelegation));
      } catch (error) {
        const errorRes = makeApiProblem(
          error,
          emptyErrorMapper,
    ...
    .post("/producerDelegations/:delegationId/accept", async (req, res) => {
      ...
      try {
        ...
        return res
          .status(200)
          .send(m2mGatewayApiV3.ProducerDelegation.parse(acceptedDelegation));
      } catch (error) {
        const errorRes = makeApiProblem(
          error,
          emptyErrorMapper,
    ...
    .post("/producerDelegations/:delegationId/reject", async (req, res) => {
      ...
      try {
        ...
        return res
          .status(200)
          .send(m2mGatewayApiV3.ProducerDelegation.parse(rejectedDelegation));
      } catch (error) {
        const errorRes = makeApiProblem(
          error,
          emptyErrorMapper,
    ...
    .post("/producerDelegations", async (req, res) => {
      ...
      try {
        ...
        return res
          .status(201)
          .send(m2mGatewayApiV3.ProducerDelegation.parse(createdDelegation));
      } catch (error) {
        const errorRes = makeApiProblem(
          error,
          emptyErrorMapper,
