...
const purposeRouter = (
  ...
  const purposeRouter = ctx.router(m2mGatewayApiV3.purposesApi.api, {
  ...
  purposeRouter
    ...
    .get("/purposes/:purposeId/versions", async (req, res) => {
      ...
      try {
        ...
        return res
          .status(200)
          .send(m2mGatewayApiV3.PurposeVersions.parse(versions));
      } catch (error) {
        const errorRes = makeApiProblem(
          error,
          emptyErrorMapper,
    ...
    .get("/purposes/:purposeId/versions/:versionId", async (req, res) => {
      ...
      try {
        ...
        return res
          .status(200)
          .send(m2mGatewayApiV3.PurposeVersion.parse(version));
      } catch (error) {
        const errorRes = makeApiProblem(
          error,
          getPurposeVersionErrorMapper,
