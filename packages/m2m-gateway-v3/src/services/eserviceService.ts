  ...
  return {
    ...
    async getEServiceDescriptorDocuments(
      ...
      descriptorId: DescriptorId,
      {
        offset,
        limit,
      }: m2mGatewayApiV3.GetEServiceDescriptorDocumentsQueryParams,
      { headers, logger }: WithLogger<M2MGatewayAppContext>
    ...
    async updateDraftEServiceDescriptor(
      eserviceId: EServiceId,
      descriptorId: DescriptorId,
      seed: m2mGatewayApiV3.EServiceDescriptorDraftUpdateSeed,
      { headers, logger }: WithLogger<M2MGatewayAppContext>
    ): Promise<m2mGatewayApiV3.EServiceDescriptor> {
      logger.info(
    ...
    async createEService(
      seed: m2mGatewayApiV3.EServiceSeed,
      { headers, logger }: WithLogger<M2MGatewayAppContext>
    ): Promise<m2mGatewayApiV3.EService> {
    ...
    async updateDraftEService(
      eserviceId: EServiceId,
      seed: m2mGatewayApiV3.EServiceDraftUpdateSeed,
      { headers, logger }: WithLogger<M2MGatewayAppContext>
    ): Promise<m2mGatewayApiV3.EService> {
    ...
    async updatePublishedEServiceDescription(
      eserviceId: EServiceId,
      seed: m2mGatewayApiV3.EServiceDescriptionUpdateSeed,
      { logger, headers }: WithLogger<M2MGatewayAppContext>
    ): Promise<m2mGatewayApiV3.EService> {
      logger.info(
    ...
    async updatePublishedEServiceName(
      eserviceId: EServiceId,
      seed: m2mGatewayApiV3.EServiceNameUpdateSeed,
      { logger, headers }: WithLogger<M2MGatewayAppContext>
    ): Promise<m2mGatewayApiV3.EService> {
      logger.info(
    ...
    async updatePublishedEServiceSignalHub(
      eserviceId: EServiceId,
      seed: m2mGatewayApiV3.EServiceSignalHubUpdateSeed,
      { headers, logger }: WithLogger<M2MGatewayAppContext>
    ): Promise<m2mGatewayApiV3.EService> {
      logger.info(
    ...
    async updateEServicePersonalDataFlag(
      eserviceId: EServiceId,
      seed: m2mGatewayApiV3.EServicePersonalDataFlagUpdateSeed,
      { headers, logger }: WithLogger<M2MGatewayAppContext>
    ): Promise<m2mGatewayApiV3.EService> {
      logger.info(
    ...
    async cancelEServiceArchiving(
      ...
      const response =
        await clients.catalogProcessClient.cancelEServiceArchiving(undefined, {
          params: { eServiceId: eserviceId },
          headers,
        });
      const polled = await pollEService(response, headers);

      return toM2MGatewayApiEService(polled.data);
    },
    ...
    async createEServiceRiskAnalysis(
      ...
      { headers, logger }: WithLogger<M2MGatewayAppContext>
    ): Promise<m2mGatewayApiV3.EServiceRiskAnalysis> {
    ...
    async updatePublishedEServiceDescriptorQuotas(
      eserviceId: EServiceId,
      descriptorId: DescriptorId,
      seed: m2mGatewayApiV3.EServiceDescriptorQuotasUpdateSeed,
      { headers, logger }: WithLogger<M2MGatewayAppContext>
    ): Promise<m2mGatewayApiV3.EServiceDescriptor> {
      logger.info(
    ...
    async getEserviceDescriptorCertifiedAttributes(
      ...
      { headers, logger }: WithLogger<M2MGatewayAppContext>
    ): Promise<m2mGatewayApiV3.EServiceDescriptorCertifiedAttributes> {
      logger.info(
    ...
    async getEserviceDescriptorDeclaredAttributes(
      ...
      { headers, logger }: WithLogger<M2MGatewayAppContext>
    ): Promise<m2mGatewayApiV3.EServiceDescriptorDeclaredAttributes> {
      logger.info(
    ...
    async getEserviceDescriptorVerifiedAttributes(
      ...
      { headers, logger }: WithLogger<M2MGatewayAppContext>
    ): Promise<m2mGatewayApiV3.EServiceDescriptorVerifiedAttributes> {
      logger.info(
    ...
    ): Promise<m2mGatewayApiV3.EServiceDescriptorCertifiedAttributesGroup> {
      ctx.logger.info(
    ...
    async createEServiceDescriptorDeclaredAttributesGroup(
      ...
      seed: m2mGatewayApiV3.EServiceDescriptorAttributesGroupSeed,
      ctx: WithLogger<M2MGatewayAppContext>
    ): Promise<m2mGatewayApiV3.EServiceDescriptorDeclaredAttributesGroup> {
      ctx.logger.info(
    ...
    async createEServiceDescriptorVerifiedAttributesGroup(
      ...
      seed: m2mGatewayApiV3.EServiceDescriptorAttributesGroupSeed,
      ctx: WithLogger<M2MGatewayAppContext>
    ): Promise<m2mGatewayApiV3.EServiceDescriptorVerifiedAttributesGroup> {
      ctx.logger.info(
