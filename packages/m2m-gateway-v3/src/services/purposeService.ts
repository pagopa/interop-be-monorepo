...
export function purposeServiceBuilder(
  ...
  return {
    async getPurposes(
      queryParams: m2mGatewayApiV3.GetPurposesQueryParams,
    ...
    async createPurpose(
      purposeSeed: m2mGatewayApiV3.PurposeSeed,
    ...
    async getPurposeVersions(
      purposeId: PurposeId,
      { limit, offset, state }: m2mGatewayApiV3.GetPurposeVersionsQueryParams,
      { logger, headers }: WithLogger<M2MGatewayAppContext>
    ): Promise<m2mGatewayApiV3.PurposeVersions> {
      logger.info(
    ...
    async getPurposeVersion(
      ...
      { logger, headers }: WithLogger<M2MGatewayAppContext>
    ): Promise<m2mGatewayApiV3.PurposeVersion> {
    ...
    async createPurposeVersion(
      purposeId: PurposeId,
      versionSeed: m2mGatewayApiV3.PurposeVersionSeed,
      { logger, headers }: WithLogger<M2MGatewayAppContext>
    ): Promise<m2mGatewayApiV3.PurposeVersion> {
      logger.info(
    ...
    async activateDraftPurpose(
      purposeId: PurposeId,
      { delegationId }: m2mGatewayApiV3.DelegationRef,
      { logger, headers }: WithLogger<M2MGatewayAppContext>
    ): Promise<m2mGatewayApiV3.Purpose> {
      logger.info(
    ...
    async createReversePurpose(
      purposeSeed: m2mGatewayApiV3.ReversePurposeSeed,
      { logger, headers, authData }: WithLogger<M2MGatewayAppContext>
    ): Promise<m2mGatewayApiV3.Purpose> {
      logger.info(
    ...
    async updateDraftReversePurpose(
      purposeId: PurposeId,
      updateSeed: m2mGatewayApiV3.ReversePurposeDraftUpdateSeed,
      { logger, headers }: WithLogger<M2MGatewayAppContext>
    ): Promise<m2mGatewayApiV3.Purpose> {
