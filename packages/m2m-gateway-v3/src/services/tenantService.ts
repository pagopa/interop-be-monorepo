...
export function tenantServiceBuilder(clients: PagoPAInteropBeClients) {
  ...
  return {
    async getTenants(
      queryParams: m2mGatewayApiV3.GetTenantsQueryParams,
      { logger, headers }: WithLogger<M2MGatewayAppContext>
    ): Promise<m2mGatewayApiV3.Tenants> {
    ...
    async getTenant(
      tenantId: TenantId,
      { logger, headers }: WithLogger<M2MGatewayAppContext>
    ): Promise<m2mGatewayApiV3.Tenant> {
    ...
    async getTenantDeclaredAttributes(
      tenantId: TenantId,
      {
        ...
        limit,
        offset,
      }: m2mGatewayApiV3.GetTenantDeclaredAttributesQueryParams,
      { logger, headers }: WithLogger<M2MGatewayAppContext>
    ...
    async assignTenantCertifiedAttribute(
      tenantId: TenantId,
      { id: attributeId }: m2mGatewayApiV3.TenantCertifiedAttributeSeed,
      { logger, headers }: WithLogger<M2MGatewayAppContext>
    ): Promise<m2mGatewayApiV3.TenantCertifiedAttribute> {
      logger.info(
    ...
    async replaceTenantCertifiedDiscreteAttribute(
      tenantId: TenantId,
      attributeId: AttributeId,
      attributeSeed: m2mGatewayApiV3.UpdateTenantCertifiedDiscreteAttributeSeed,
      ...
      const updateResponse =
        await clients.tenantProcessClient.tenantAttribute.updateCertifiedDiscreteAttributeById(
          {
            certifiedDiscreteValue: attributeSeed.certifiedDiscreteValue,
          },
          {
            params: {
              tenantId,
    ...
    async getTenantVerifiedAttributes(
      tenantId: TenantId,
      { limit, offset }: m2mGatewayApiV3.GetTenantVerifiedAttributesQueryParams,
      { logger, headers }: WithLogger<M2MGatewayAppContext>
    ...
    async getTenantVerifiedAttributeVerifiers(
      ...
      attributeId: AttributeId,
      {
        limit,
        offset,
      }: m2mGatewayApiV3.GetTenantVerifiedAttributeVerifiersQueryParams,
      { logger, headers }: WithLogger<M2MGatewayAppContext>
    ): Promise<m2mGatewayApiV3.TenantVerifiedAttributeVerifiers> {
      logger.info(
    ...
    async getTenantVerifiedAttributeRevokers(
      ...
      attributeId: AttributeId,
      {
        limit,
        offset,
      }: m2mGatewayApiV3.GetTenantVerifiedAttributeRevokersQueryParams,
      { logger, headers }: WithLogger<M2MGatewayAppContext>
    ): Promise<m2mGatewayApiV3.TenantVerifiedAttributeRevokers> {
      logger.info(
