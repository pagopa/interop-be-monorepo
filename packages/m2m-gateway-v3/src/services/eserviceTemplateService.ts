...
export function eserviceTemplateServiceBuilder(
  ...
  return {
    ...
    ): Promise<m2mGatewayApiV3.EServiceTemplate> {
    ...
    async getEServiceTemplateVersions(
      templateId: EServiceTemplateId,
      queryParams: m2mGatewayApiV3.GetEServiceTemplateVersionsQueryParams,
      { logger, headers }: WithLogger<M2MGatewayAppContext>
    ): Promise<m2mGatewayApiV3.EServiceTemplateVersions> {
    ...
    async getEServiceTemplateVersion(
      ...
      versionId: EServiceTemplateVersionId,
      { logger, headers }: WithLogger<M2MGatewayAppContext>
    ): Promise<m2mGatewayApiV3.EServiceTemplateVersion> {
      logger.info(
    ...
    async createEServiceTemplateVersion(
      templateId: EServiceTemplateId,
      seed: m2mGatewayApiV3.EServiceTemplateVersionSeed,
    ...
    async createEServiceTemplateRiskAnalysis(
      ...
      { headers, logger }: WithLogger<M2MGatewayAppContext>
    ): Promise<m2mGatewayApiV3.EServiceTemplateRiskAnalysis> {
      logger.info(
    ...
    async getEServiceTemplateRiskAnalyses(
      templateId: EServiceTemplateId,
      {
        limit,
        offset,
      }: m2mGatewayApiV3.GetEServiceTemplateRiskAnalysesQueryParams,
      { logger, headers }: WithLogger<M2MGatewayAppContext>
    ): Promise<m2mGatewayApiV3.EServiceTemplateRiskAnalyses> {
      logger.info(
    ...
    async createEServiceTemplate(
      seed: m2mGatewayApiV3.EServiceTemplateSeed,
      { headers, logger }: WithLogger<M2MGatewayAppContext>
    ): Promise<m2mGatewayApiV3.EServiceTemplate> {
    ...
    async updatePublishedEServiceTemplateVersionQuotas(
      ...
      seed: m2mGatewayApiV3.EServiceTemplateVersionQuotasUpdateSeed,
      { headers, logger }: WithLogger<M2MGatewayAppContext>
    ): Promise<m2mGatewayApiV3.EServiceTemplateVersion> {
      logger.info(
    ...
    async updateDraftEServiceTemplate(
      templateId: EServiceTemplateId,
      seed: m2mGatewayApiV3.EServiceTemplateDraftUpdateSeed,
      { headers, logger }: WithLogger<M2MGatewayAppContext>
    ): Promise<m2mGatewayApiV3.EServiceTemplate> {
    ...
    async getEServiceTemplateVersionDocuments(
      ...
      versionId: EServiceTemplateVersionId,
      {
        offset,
        limit,
      }: m2mGatewayApiV3.GetEServiceTemplateVersionDocumentsQueryParams,
      { headers, logger }: WithLogger<M2MGatewayAppContext>
    ...
    async updatePublishedEServiceTemplateDescription(
      templateId: EServiceTemplateId,
      seed: m2mGatewayApiV3.EServiceTemplateDescriptionUpdateSeed,
      { logger, headers }: WithLogger<M2MGatewayAppContext>
    ): Promise<m2mGatewayApiV3.EServiceTemplate> {
      logger.info(
    ...
    async updatePublishedEServiceTemplateIntendedTarget(
      templateId: EServiceTemplateId,
      seed: m2mGatewayApiV3.EServiceTemplateIntendedTargetUpdateSeed,
      { logger, headers }: WithLogger<M2MGatewayAppContext>
    ): Promise<m2mGatewayApiV3.EServiceTemplate> {
      logger.info(
    ...
    async updatePublishedEServiceTemplateName(
      templateId: EServiceTemplateId,
      seed: m2mGatewayApiV3.EServiceTemplateNameUpdateSeed,
      { logger, headers }: WithLogger<M2MGatewayAppContext>
    ): Promise<m2mGatewayApiV3.EServiceTemplate> {
      logger.info(
    ...
    ): Promise<m2mGatewayApiV3.EServiceTemplateVersionCertifiedAttributesGroup> {
      ctx.logger.info(
    ...
    async createEServiceTemplateVersionDeclaredAttributesGroup(
      ...
      seed: m2mGatewayApiV3.EServiceTemplateVersionAttributesGroupSeed,
      ctx: WithLogger<M2MGatewayAppContext>
    ): Promise<m2mGatewayApiV3.EServiceTemplateVersionDeclaredAttributesGroup> {
      ctx.logger.info(
    ...
    async createEServiceTemplateVersionVerifiedAttributesGroup(
      ...
      seed: m2mGatewayApiV3.EServiceTemplateVersionAttributesGroupSeed,
      ctx: WithLogger<M2MGatewayAppContext>
    ): Promise<m2mGatewayApiV3.EServiceTemplateVersionVerifiedAttributesGroup> {
      ctx.logger.info(
    ...
    async getEserviceTemplateVersionCertifiedAttributes(
      ...
      versionId: EServiceTemplateVersionId,
      {
        limit,
        offset,
      }: m2mGatewayApiV3.GetEServiceTemplateVersionCertifiedAttributesQueryParams,
      { headers, logger }: WithLogger<M2MGatewayAppContext>
    ): Promise<m2mGatewayApiV3.EServiceTemplateVersionCertifiedAttributes> {
      logger.info(
    ...
    async getEserviceTemplateVersionDeclaredAttributes(
      ...
      versionId: EServiceTemplateVersionId,
      {
        limit,
        offset,
      }: m2mGatewayApiV3.GetEServiceTemplateVersionDeclaredAttributesQueryParams,
      { headers, logger }: WithLogger<M2MGatewayAppContext>
    ): Promise<m2mGatewayApiV3.EServiceTemplateVersionDeclaredAttributes> {
      logger.info(
    ...
    async getEserviceTemplateVersionVerifiedAttributes(
      ...
      versionId: EServiceTemplateVersionId,
      {
        limit,
        offset,
      }: m2mGatewayApiV3.GetEServiceTemplateVersionVerifiedAttributesQueryParams,
      { headers, logger }: WithLogger<M2MGatewayAppContext>
    ): Promise<m2mGatewayApiV3.EServiceTemplateVersionVerifiedAttributes> {
      logger.info(
