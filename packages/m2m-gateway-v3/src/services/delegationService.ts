...
export function delegationServiceBuilder(clients: PagoPAInteropBeClients) {
  ...
  return {
    ...
    ): Promise<m2mGatewayApiV3.ConsumerDelegations> {
      logger.info(
    ...
    async createConsumerDelegation(
      seed: m2mGatewayApiV3.DelegationSeed,
      { headers, logger }: WithLogger<M2MGatewayAppContext>
    ): Promise<m2mGatewayApiV3.ConsumerDelegation> {
      logger.info(
    ...
    async rejectConsumerDelegation(
      delegationId: string,
      { rejectionReason }: m2mGatewayApiV3.DelegationRejection,
      { headers, logger }: WithLogger<M2MGatewayAppContext>
    ): Promise<m2mGatewayApiV3.ConsumerDelegation> {
    ...
    async getProducerDelegations(
      ...
      { headers, logger }: WithLogger<M2MGatewayAppContext>
    ): Promise<m2mGatewayApiV3.ProducerDelegations> {
      logger.info(
    ...
    async acceptProducerDelegation(
      delegationId: string,
      { headers, logger }: WithLogger<M2MGatewayAppContext>
    ): Promise<m2mGatewayApiV3.ProducerDelegation> {
