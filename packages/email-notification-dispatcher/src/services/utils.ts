...
export const eventMailTemplateType = {
  ...
  agreementSuspendedByProducerMailTemplate: "agreement-suspended-by-producer-mail",
  agreementUnsuspendedByProducerMailTemplate: "agreement-unsuspended-by-producer-mail",
