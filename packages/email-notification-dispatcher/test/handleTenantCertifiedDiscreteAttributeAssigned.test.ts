...
import { handleTenantCertifiedDiscreteAttributeAssigned } from "../src/handlers/tenants/handleTenantCertifiedDiscreteAttributeAssigned.js";
...
describe("handleTenantCertifiedDiscreteAttributeAssigned", async () => {
  ...
  it("should generate no messages when attribute has no origin", async () => {
    ...
    const messages = await handleTenantCertifiedDiscreteAttributeAssigned({
      tenantV2Msg: toTenantV2(targetTenant),
