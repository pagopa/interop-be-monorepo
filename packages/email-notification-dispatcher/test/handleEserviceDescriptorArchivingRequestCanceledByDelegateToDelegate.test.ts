...
import { handleEServiceDescriptorArchivingRequestCanceledByDelegateToDelegate } from "../src/handlers/eservices/handleEserviceDescriptorArchivingRequestCanceledByDelegateToDelegate.js";
import {
  addOneDelegation,
  addOneEService,
  addOneTenant,
...
describe("handleEServiceDescriptorArchivingRequestCanceledByDelegateToDelegate", async () => {
  ...
  it("should generate one message per delegator user with the expected subject", async () => {
    const messages =
      await handleEServiceDescriptorArchivingRequestCanceledByDelegateToDelegate(
        {
