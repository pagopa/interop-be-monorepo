...
describe("get eservices", () => {
  ...
  it("should not include eservices templates with no versions (requester is the creator, not admin nor api, nor support)", async () => {
    const eserviceTemplate6: EServiceTemplate = {
      ...mockEServiceTemplate,
      id: generateId(),
      name: "eservice template 006",
  ...
  it("should not include eservice templates with no versions (requester is not the creator)", async () => {
    const eserviceTemplate6: EServiceTemplate = {
      ...mockEServiceTemplate,
      id: generateId(),
      name: "eservice template 006",
