...
import { PurposeRiskAnalysisReviewerSchema } from "../purpose/purposeRiskAnalysisReviewer.js";
...
export const PurposeDbTableReadModel = {
  ...
  purpose_risk_analysis_reviewer: riskAnalysisReviewerInReadmodelPurpose,
