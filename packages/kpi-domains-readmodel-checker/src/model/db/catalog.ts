...
import { EserviceDescriptorAsyncExchangeSchema } from "../catalog/eserviceDescriptorAsyncExchange.js";
...
export const CatalogDbTableConfig = {
  ...
  eservice_descriptor_async_exchange: EserviceDescriptorAsyncExchangeSchema,
